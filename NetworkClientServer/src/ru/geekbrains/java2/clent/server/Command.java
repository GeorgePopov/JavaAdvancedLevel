...
// теперь по сети будут передоваться объекты (экземпляры этиъ классов)
// !*!*! что бы по сети передавать объекты необходимо превратить его в массив байт,
// а что бы прочитатьобратно из мессива байт в объект - этот процесс называется Скрализацией (Serializable),
